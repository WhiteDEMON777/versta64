...
elseif ($pugin_slug == 'wd-instagram-feed' || $pugin_slug == 'wd-facebook-feed' || $pugin_slug == 'slider-wd' || $pugin_slug == 'post-slider-wd') {
    ...
    <div id="tenweb_menu_content">
        ...
        <?php if ($pugin_view == "image-optimizer") : ?>
            <div id="image_optimizer">
                <div id="image_optimizer_content">
                    ...
                    <div id="separator" style="left: 50%;"><span class="left-arr"></span><span class="right-arr"></span></div>
                </div>
            </div>
        ...
        <?php elseif ($pugin_view == "performance") : ?>
            <div class="header-tab-content">
                <img class="img_url_screen" src="<?php echo TENWEB_URL_IMG . '/plugins_from/performance/performance_screen.png'; ?>">
                <img class="img_url_tablet" src="<?php echo TENWEB_URL_IMG . '/plugins_from/performance/performance_screen.png'; ?>">
                <img class="img_url_mobile" src="<?php echo TENWEB_URL_IMG . '/plugins_from/performance/performance_mobile.png'; ?>">
            </div>
        <?php endif; ?>
    </div>
                ...
                <div class="features-container clear">
                  <?php foreach ($plugins[$pugin_view]["features"] as $feature) : ?>
                    <div class="feature clear">
                        <div class="feature-image-cont" style="background-image: url(<?php echo TENWEB_URL_IMG . $feature["img"]; ?>);"></div>
