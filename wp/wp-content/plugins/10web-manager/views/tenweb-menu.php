...
$services = array(
  ...
  "builder" => array(
    "title" => "Website builder on top of Elementor",
...
<div id="tenweb_menu" class="about_tenweb">
    ...
    <div id="manager_header" class="content_section">
        ...
        <div id="manager_header_bg">
            <div id="manager_header_animation" class="clear animate-blocks">
                <div id="header_animation1" class="animate-block bottom floating-img" data-parallax='["y": -160, "smoothness": 0]'></div>
                <div id="header_animation2" class="animate-block top floating-img" data-parallax='["y": 160, "smoothness": 0]'></div>
                <div id="header_animation3" class="animate-block bottom floating-img" data-parallax='["y": -160, "smoothness": 0]'></div>
                <div id="header_animation4" class="animate-block top floating-img" data-parallax='["y": 160, "smoothness": 0]'></div>
            </div>
            <div class="container">
                ...
                <h1 class="section-title animate-words">
                    <span class="word-container w1"><span>All-In-One WordPress</span></span>
                    <span class="word-container w2"><span>Website Builder</span></span>
                </h1>
                <h2 class="section-title animate-words">
                    <span class="word-container word-container-sub w3"><span>Build and Host WordPress Websites in Minutes</span></span>
                </h2>
                <div id="manager_header_buttons">
                    <a href="<?php echo $registration_link; ?>" class="button orange button_content animate_button"> CONNECT</a>
                    <span class="manager_watch_video animate_button" id="watch_video" data-id="hnAQvMdy_l4">Watch video</span>
                </div>
    ...
    <div id="manager_section_4" class="content_section">
        <div class="container">
            ...
            <div class="clear tenweb_comp">
                <div class="clear">
                    <div class="image_cont"><img class="vertical-middle " src="<?php echo TENWEB_URL_IMG.'/platform.svg' ?>"></div>
                    <div class="content">
                ...
                <div class="clear">
                    <div class="image_cont"><img class="vertical-middle " src="<?php echo TENWEB_URL_IMG.'/building.svg' ?>"></div>
                    <div class="content">
                        <h3>Easy Website-Building</h3>
                        <p>Build beautiful websites using Elementor enhanced with our premium widgets. Choose from dozens of templates.</p>
                    </div>
                </div>
                <div class="clear">
                    <div class="image_cont"><img class="vertical-middle " src="<?php echo TENWEB_URL_IMG.'/hosting.svg' ?>"></div>
                    <div class="content">
                ...
                <div class="clear">
                    <div class="image_cont"><img class="vertical-middle " src="<?php echo TENWEB_URL_IMG.'/migration.svg' ?>"></div>
                    <div class="content">
                        <h3>Free Automatic Migration</h3>
                        <p>Automatically move your website to 10Web-managed hosting with a single click.</p>
                    </div>
                </div>
                <div class="clear">
                    <div class="image_cont"><img class="vertical-middle " src="<?php echo TENWEB_URL_IMG.'/plugins.svg' ?>"></div>
                    <div class="content">
                ...
                <div class="clear">
                    <div class="image_cont"><img class="vertical-middle " src="<?php echo TENWEB_URL_IMG.'/services.svg' ?>"></div>
                    <div class="content">
    ...
    <div id="manager_section_9" class="content_section ">
        <div class="container">
            <h2 class="plugin-section-header section-title">Platform for building and hosting beautiful WordPress websites</h2>
            <div>
                <a href="<?php echo $registration_link; ?>" class="button orange button_content animate_button"> CONNECT</a>
            </div>
        </div>
