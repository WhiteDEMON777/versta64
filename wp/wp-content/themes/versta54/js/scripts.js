...
var isMobileCustom = {
    ...
    any: function() {
        return (isMobileCustom.Android() || isMobileCustom.BlackBerry() || isMobileCustom.iOS() || isMobileCustom.Opera() || isMobileCustom.Windows());
    }
};
  ...
  $('#banner .carousel.main ul').carouFredSel({
    ...
    swipe: {
      ...
      onTouch: true
	  	...
	  	prev: {button: "#banner_prev", event: "click"},
		next: {button: "#banner_next", event: "click"}
  });
///////////////////////////////////////////////////////////////
  $('#partners .carousel.main ul').carouFredSel({
	...
	prev: {button: "#partners_prev", event: "click"},
    next: {button: "#partners_next", event: "click"}
  });
///////////////////////////////////////////////////////////////
